      ...
      <main className="bg-base min-h-screen">
        ...
        <section className="relative py-24 overflow-hidden bg-gradient-to-b from-gray-900 via-secondary to-gray-900 mt-20 lg:mt-28">
          ...
          <div className="relative max-w-3xl mx-auto px-4">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight">
              ¿Por qué necesito una página web para <br />
        ...
        <article className="max-w-3xl mx-auto px-4 py-12 text-gray-700">
          <p className="text-xl text-gray-600 mb-8">
            ...
            necesitan una página web. La respuesta en 2026 es un rotundo <strong>sí</strong> — y en
            este artículo te explicamos exactamente por qué.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
            {[
              { icon: <Users size={24} />, stat: '88%', desc: 'investiga online antes de comprar' },
              {
                icon: <Globe size={24} />,
                stat: '72%',
                desc: 'de búsquedas locales visitan el negocio',
              },
              {
                icon: <TrendingUp size={24} />,
                stat: '3x',
                desc: 'más consultas con sitio profesional',
              },
              {
                icon: <ShoppingCart size={24} />,
                stat: '24/7',
                desc: 'disponible para tus clientes',
              },
            ].map((item, i) => (
          ...
          <p className="mb-6">
            El 97% de los consumidores en Chile usa internet para encontrar negocios locales. Si no
            tienes una página web, simplemente <strong>no existes</strong> para esas personas. Tu
            competencia sí tiene sitio web y está captando a los clientes que deberían ser tuyos.
          </p>
          ...
          <p className="mb-4">
            Instagram y Facebook son excelentes para generar visibilidad, pero tienen limitaciones
            importantes:
          </p>
          ...
          <p className="mb-6">
            Tu sitio web nunca duerme. Mientras tú descansas, tu página web puede estar respondiendo
            preguntas, mostrando tus servicios y recibiendo consultas o pedidos de clientes. Es como
            tener un vendedor trabajando tiempo completo sin pagar sueldos.
          </p>
          ...
          <p className="mb-4">
            ...
            . Un sitio profesional transmite:
          </p>
          <ul className="space-y-3 mb-8">
            {[
          ...
          <p className="mb-6">
            Una página web bien diseñada y optimizada puede poner a tu pequeño negocio al mismo
            nivel que grandes empresas en los resultados de Google. El SEO no discrimina por tamaño
            — discrimina por relevancia y calidad de contenido.
          </p>
          ...
          <p className="mb-6">
            <strong>Ahora.</strong> Cada día sin página web es un día que tu competencia está
            captando a tus clientes potenciales. No esperes a tener "todo listo" — starts small,
            crece con el tiempo. Una landing page básica bien hecha es mejor que nada y puede
            lanzarse en 7 días.
          </p>

          <h2 className="text-2xl font-bold text-gray-800 mb-4 mt-10">Preguntas frecuentes</h2>
            ...
            {[
              ...
              <details key={i} className="border border-gray-200 rounded p-4 group">
                <summary className="font-semibold text-gray-800 cursor-pointer list-none flex justify-between items-center">
                  ...
                  <ChevronRight
                    size={16}
                    className="text-primary group-open:rotate-90 transition-transform"
                  />
                </summary>

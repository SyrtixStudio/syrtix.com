      ...
      ? {
          ...
          packages: [
            ...
            },
            {
              ...
              features: [
                { text: 'Everything in Landing Starter', included: true },
            ...
            },
            {
              ...
              conditionNote: 'Hosting and transactional email providers are billed by usage.',
              features: [
                { text: 'Everything in Corporate Web', included: true },
            ...
            },
            {
              ...
              conditionNote: 'Hosting and transactional email providers are billed by usage.',
              features: [
                { text: 'Everything in Ecommerce Standard', included: true },
      ...
      : {
          ...
          packages: [
            ...
            },
            {
              ...
              features: [
                { text: 'Todo lo de Landing Starter', included: true },
            ...
            },
            {
              ...
              conditionNote: 'Hosting y proveedores de correo transaccional se cobran segun uso.',
              features: [
                { text: 'Todo lo de Web Corporativa', included: true },
            ...
            },
            {
              ...
              conditionNote: 'Hosting y proveedores de correo transaccional se cobran segun uso.',
              features: [
                { text: 'Todo lo de Ecommerce Standard', included: true },

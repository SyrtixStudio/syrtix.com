          ...
          packages: [
            {
              ...
              features: [
                ...
                { text: 'Responsive website (PC, tablets & mobile)', included: true },
            ...
            },
            {
              ...
              features: [
                ...
                { text: 'Essential SEO', included: true },
                { text: 'Priority support', included: false },
              ],
              ctaText: 'Choose Pro',
              ctaLink: '/contacto',
          ...
          packages: [
            {
              ...
              features: [
                ...
                { text: 'Web responsive (PC, tabletas y moviles)', included: true },
            ...
            },
            {
              ...
              features: [
                ...
                { text: 'SEO esencial', included: true },
                { text: 'Soporte prioritario', included: false },
              ],
              ctaText: 'Elegir Pro',
              ctaLink: '/contacto',

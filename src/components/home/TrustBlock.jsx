...
const formatRelativeReviewTime = (createdAt, lang) => {
  ...
  const diffH = Math.max(0, Math.floor((now - parsed) / 36e5));
  if (diffH < 24) {
...
function TrustBlock() {
  ...
  const t =
    lang === 'en'
      ? {
          ...
          securitySubtitle:
            'All our websites include best security practices to protect your business. Now with advanced chatbot and n8n automation integration.',
          securityFeatures: [
            {
              id: 'ssl',
              icon: Lock,
              title: 'SSL/HTTPS certificate',
              desc: 'Encrypted connections. The green lock that builds trust.',
            },
            {
              id: 'data',
              icon: Shield,
              title: 'Data protection',
              desc: 'We comply with privacy standards. Your data is protected.',
            },
            {
              id: 'hosting',
              icon: Server,
              title: 'Secure hosting',
              desc: 'High-availability servers with backups and DDoS protection.',
            },
            {
              id: 'code',
              icon: CheckCircle,
              title: 'Secure code',
              desc: 'OWASP best practices to prevent vulnerabilities.',
            },
          ],
          badges: [
            'Secure SSL',
          ...
          ctaDesc:
            'Tell us about your project and get a custom proposal. No commitments, no hidden fees.',
      ...
      : {
          ...
          securitySubtitle:
            'Todos nuestros sitios incluyen las mejores prácticas de seguridad. Ahora con integración avanzada de chatbot inteligente y automatización n8n.',
          securityFeatures: [
            {
              id: 'ssl',
              icon: Lock,
              title: 'Certificado SSL/HTTPS',
              desc: 'Conexión cifrada y segura. El candado que genera confianza.',
            },
            {
              id: 'data',
              icon: Shield,
              title: 'Protección de datos',
              desc: 'Cumplimos normativas de privacidad. Tus datos están protegidos.',
            },
            {
              id: 'hosting',
              icon: Server,
              title: 'Hosting seguro',
              desc: 'Servidores de alta disponibilidad con backups y protección DDoS.',
            },
            {
              id: 'code',
              icon: CheckCircle,
              title: 'Código seguro',
              desc: 'Mejores prácticas OWASP para prevenir vulnerabilidades.',
            },
          ],
          badges: [
            'SSL seguro',
          ...
          ctaDesc:
            'Cuéntanos sobre tu proyecto y recibe una propuesta personalizada. Sin compromisos, sin costos ocultos.',
  ...
  const badgeIcons = [Lock, Shield, Server, CheckCircle, Workflow];
  ...
  return (
    <section className="bg-base2">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-xs text-gray-500">
                          {formatRelativeReviewTime(item.createdAt, lang)}
                        </p>
                      </div>
                    </div>
                    <img
        ...
        <div className="max-w-[1440px] mx-auto relative z-10">
          <div className="text-center mb-12" data-aos="fade-up">
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">
              {t.securityTitle}
              <span className="text-primary">{t.securityHighlight}</span>
            </h2>
            <div className="h-1 w-16 bg-primary mx-auto mb-4" />
      ...
      {/* CTA final eliminado por petición del equipo */}
    </section>
  );
}
